  ...
  return (
    <div className='max-w-[1400px] lg:h-[700px] sm:h-[1000px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4 room'>
        ...
        <div className='grid grid-cols-2 col-span-2 gap-2'>
            ...
            <img className='object-cover w-full h-full ' style="display: block; " src="https://plus.unsplash.com/premium_photo-1678297269980-16f4be3a15a6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" />
        </div>
    </div>
  )
}
